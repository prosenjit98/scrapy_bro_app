...
export default function PartsVendorListScreen({ navigation }: any) {
  ...
  const { data: partObject, isLoading, refetch, isRefetching } = useVendorParts(user?.id!);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <LinearGradient style={styles.headerGradient} colors={['#0a5e43', '#82c91f']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
        <View style={styles.headerTop}>
          <View>
            <Text style={styles.headerTitle}>Scrapy</Text>
            <Text style={styles.headerSubtitle}>List your products</Text>
          </View>
